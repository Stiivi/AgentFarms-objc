...
- (int)browser:(NSBrowser *)sender numberOfRowsInColumn:(int)column
{
    ...
    AFSimulator         *simulator = [farm simulator];
...
- (void)loadCell:(ObjectBrowserCell *)cell
{
    ...
    if([cell parentCell])
    {
        ...
        {
            /* FIXME: this is ugly */
            ref = [[farm simulator] referenceForObjectAtIndex:[[cell identifier] intValue]
    ...
    {
        /* We are at root */
        ref = [[farm simulator] referenceForObjectWithName:[cell title]];
        if(!ref)
        {
    ...
    object = [[farm simulator] descriptionForObjectWithReference:ref];        

    [cell setObjectReference:ref];
    [cell setObject:object];
    [cell setClassDescription:[[farm model] descriptionForClassWithName:[object objectClassName]]];
