...
- (void)refresh:(id)sender
{
    ...
    ASSIGN(prototypeNames, [[farm model] prototypeNames]);
...
- (void)prototypeSelected:(id)sender
{
    ASSIGN(prototype, [[farm model] prototypeWithName:[[browser selectedCell] title]]);
    ASSIGN(classDescription, [[farm model] descriptionForClassWithName:[prototype objectClassName]]);
    [tableView reloadData];
}
/**************************************************************************
    Table data source
